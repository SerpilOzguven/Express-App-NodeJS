...
sgMail.setApiKey('SG.SK8fed52be8ff1cc739480855536d94c3e');
...
exports.postRegister = (req, res, next) => {
    ...
    User.findOne({ email: email })
        ...
        .then(() => {
            ...
            const msg = {
                to: email, //kayıt olurken verilen email adresi
                from: 'ozgser-1470@hotmail.com',
    ...
    crypto.randomBytes(32, (err, buffer) => {
        ...
        User.findOne({ email: email })
            .then(user => {
                ...
                const msg = {
                    to: email, //kayıt olduğu email adresi
                    from: 'ozgser-1470@hotmail.com',
